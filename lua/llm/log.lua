...
-- Join dir + filename regardless of whether dir has a trailing slash.
-- Exported for unit testing.
function M._build_log_path(dir, date)
  return (dir:gsub("/+$", "")) .. "/" .. date .. ".jsonl"
end
...
function M.log(log_entry)
  ...
  local log_file_path = M._build_log_path(data_dir, os.date("%Y-%m-%d"))
  ensure_dir(data_dir)
